...
<head>
  ...
  <link rel="icon" type="image/png "href="{{ URL::asset('images/rocket.png') }}">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown notification danger">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <div class="count">{{ $countComplaint }}</div>
          </a>
          <div class="dropdown-menu">
            <ul>
              ...
              <li>
                <a href="#">
                  <span class="badge badge-danger pull-right">{{ $countComplaint }}</span>
                  <div class="message">
                    <div class="content">
...
<div class="row">
  ...
  <div class="card-body">
    ...
    <div class="content">
      ...
      <div class="value">{{ $countUsers }}<span class="sign">Users</span></div>
    </div>
  </div>
</a>
</div>
<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
  ...
  <div class="card-body">
    ...
    <div class="content">
      <div class="title">Type Trash</div>
      <div class="value">{{ $countTrash }}<span class="sign">Trash</span></div>
    </div>
  </div>
</a>
</div>
      ...
      <a class="card card-banner card-orange-light">
        <div class="card-body">
          <i class="icon fa fa-exclamation-circle fa-4x"></i>
            <div class="content">
              <div class="title">Complaints</div>
              <div class="value">{{ $countComplaint }}<span class="sign">Complaints</span></div>
            </div>
        </div>
      </a>
</div>
