...
<head>
  ...
  <link rel="icon" type="image/png "href="{{ URL::asset('images/unknow.jpg') }}">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form id="modal-form-add" action="{{ route('data-users.store','tes') }}" method="post">
            {{ csrf_field() }}
...
<div id="editData" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="modal-form-edit" action="{{ route('data-users.update','tes') }}" method="post" >
          {{ method_field('patch') }}
          {{ csrf_field() }}
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="modal-form-delete" method="post" action="{{route('data-users.destroy','test')}}">
            {{ method_field('delete') }}
            {{ csrf_field() }}
      <div class="modal-body">
            <input type="hidden" name="no_ktp" id="cat_noktp" value="">
...
<div class="row">
    ...
    @foreach($users as $key => $data)
        <tr>
            ...
            <td>
               ...
               <button class="btn btn-xs btn-info" data-toggle="modal" data-target="#detailData" data-no_ktp="{{ $data->no_ktp }}" data-name_user="{{ $data->name_users }}" data-email="{{ $data->email }}" data-address="{{ $data->address }}">
                 <span class="fa fa-info-circle"></span> Detail
               </button>
               <button class="btn btn-xs btn-warning" data-toggle="modal" data-target="#editData" data-no_ktp="{{ $data->no_ktp }}" data-name_user="{{ $data->name_users }}" data-email="{{ $data->email }}" data-address="{{ $data->address }}">
                 <span class="fa fa-edit"></span> Edit
               </button>
               <button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteData" data-no_ktp="{{ $data->no_ktp }}">
  ...
  <script type="text/javascript">
      $(document).ready(function(){
          ...
          // 					).then(OK => {
          //             if(OK){
          //               window.location.href = "{{ route('datausers') }}";
          //             }
          //           });
          // 				} else{
          //           $('#addData').modal('hide');
