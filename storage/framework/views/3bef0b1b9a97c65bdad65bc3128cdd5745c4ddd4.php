...
-->
<title>Login</title>
<link rel="icon" type="images/png" href="<?php echo e(URL::asset('images/padlock.png')); ?>">
            ...
            <?php echo e(csrf_field()); ?>
              ...
              <input name="password" type="password" class="form-control" id="password" placeholder="Password" required/>
						<div class="col-md-6 col-sm-10">
							<button type="submit" name="submit" class=" btn btn-danger" id="submit">Login</button>
						</div>
            <div class="col-md-6 col-sm-10">
							<br><br><br><a href = "<?php echo e(route('login')); ?>">Lupa Password ?</a>
						</div>
					</form>
				</div>
			</div>
    ...
    <div class="wow fadeInUp col-md-offset-1 col-md-5 col-sm-6" data-wow-delay="0.6s">
      <div class="contact_des">
        <font color="white">
          ...
          <p><font color="white">Anda bisa login disamping ini.</font></p>
          <p></p>
        <a href="<?php echo e(route('home')); ?>" class="btn btn-danger">HOME</a>
      </div>
    </div>
