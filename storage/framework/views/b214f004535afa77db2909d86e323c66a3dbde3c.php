...
-->
<title>Home</title>
<link rel="icon" type="images/png" href="<?php echo e(URL::asset('images/rocket.png')); ?>">
...
<link rel="stylesheet" href="<?php echo e(URL::asset('css/owl.theme.css')); ?>">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-left"> <br>
				<a href="<?php echo e(route('login')); ?>"><input type="button" name="login" value="Login Admin" class="btn btn-primary wow fadeInUp" data-wow-delay="2.9s"></a> &nbsp;
				
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li><a href="<?php echo e(route('home')); ?>" class="smoothScroll">Home</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(URL::asset('images/3.png')); ?>" align="center" class="wow bounceIn" data-wow-delay="1.6s"></img></a>
...
<script src="<?php echo e(URL::asset('js/jquery.parallax.js')); ?>"></script>
<script src="<?php echo e(URL::asset('js/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('js/smoothscroll.js')); ?>"></script>
